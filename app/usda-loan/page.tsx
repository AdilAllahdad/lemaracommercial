...
export const metadata: Metadata = {
  title: 'USDA Commercial Loans | Lemara Commercial',
  description: 'Discover USDA commercial loan options for rural business development. Get flexible financing solutions backed by the USDA with Lemara Commercial.',
};
    ...
    <main>
      <div className="relative py-24 md:py-32 bg-gray-900">
        <div
          ...
          style={{
            backgroundImage: `url('/images/Loan_RealEstate_a.jpg')`,
          }}
        >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex justify-center space-x-4 text-white/90">
                ...
                <span>/</span>
                <span className="text-primary">USDA Loans</span>
              </div>
            </div>
