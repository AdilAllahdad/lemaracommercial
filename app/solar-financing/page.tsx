...
export const metadata: Metadata = {
  title: 'Solar Financing | Lemara Commercial',
  description: 'Explore solar financing options for your commercial property. Get flexible financing solutions for solar installations with Lemara Commercial.',
};
    ...
    <main>
      <div className="relative py-24 md:py-32 bg-gray-900">
        <div
          ...
          style={{
            backgroundImage: `url('/images/Loan_Construction_a.jpg')`,
          }}
        >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex justify-center space-x-4 text-white/90">
                ...
                <span>/</span>
                <span className="text-primary">Solar Financing</span>
              </div>
            </div>
